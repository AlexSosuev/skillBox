...
public class Main {
    ...
    private static final Marker markerSearch = MarkerManager.getMarker("INPUT_HISTORY");
    private static final Marker markerInputError = MarkerManager.getMarker("INVALID_STATIONS");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                logger.info(markerSearch, "Пользователь ввел станцию: {}.",  station);
                return station;
            }
            logger.warn(markerInputError, "Станция \"{}\" не найдена: ", line);
        }
    }
